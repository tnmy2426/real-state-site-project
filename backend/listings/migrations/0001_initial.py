# Generated by Django 3.1.3 on 2020-11-20 20:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('home_type', models.CharField(choices=[('House', 'House'), ('Guest House', 'Guest House'), ('Town House', 'Town House')], default='House', max_length=100)),
                ...
                ('businessman', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='businessmans.businessman')),
            ],
        ),
    ]
